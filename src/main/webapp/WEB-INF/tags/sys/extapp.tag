...
<div id="extappModal" class="modal" tabindex="-1" role="dialog" >
    <div class="modal-dialog" style="width: 850px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="extapp-btn-ok" type="button" class="btn btn-primary btn-sm" data-loading-text="正在提交...">确定</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
<script type="text/javascript">
    $(function () {
        ...
        $("#extapp-btn-qry").click(function () {
            $extappTable.setGridParam({page: 1}).trigger("reloadGrid");
        });
        ...
        $("#extapp-btn-reset").click(function () {
            ...
            $('#qry_is_valid').val('');
            $('#qry_app_type').val('');
            $extappTable.trigger("reloadGrid");
        });

        $("#extapp-btn-ok").click(function () {
            var id = $extappTable.jqGrid('getGridParam', "selrow");
            if (!id) {
        ...
        $("a[name='button-search-app']").click(function () {
            if(!$extappTable){
                ...
                $extappTable.jqGrid('navGrid', '#tablePager', {
                    edit: false,
                    add: false,
                    del: false,
                    search: false,
