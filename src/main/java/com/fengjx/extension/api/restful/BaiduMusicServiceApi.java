...
import com.fengjx.wechat.sdk.fastweixin.message.MusicMsg;
...
public class BaiduMusicServiceApi {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BaiduMusicServiceApi.class);

    // 测试方法
    public static void main(String[] args) {
        MusicMsg music = searchMusic("相信自己", "零点乐队");
     ...
     * @return Music
     */
    public static MusicMsg searchMusic(String musicTitle, String musicAuthor) {
        // 百度音乐搜索地址
        ...
        // 从返回结果中解析出Music
        MusicMsg music = parseMusic(inputStream);
    ...
    private static MusicMsg parseMusic(InputStream inputStream) {
        if (null == inputStream) {
            return null;
        }
        MusicMsg music = null;
