...
package com.fengjx.extension.api.tuling.vo;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.fengjx.common.utils.JsonUtil;
import com.fengjx.extension.api.tuling.vo.resp.BaseRespBean;
import com.fengjx.extension.api.tuling.vo.resp.FlightBean;
import com.fengjx.extension.api.tuling.vo.resp.HotelBean;
import com.fengjx.extension.api.tuling.vo.resp.LinkBean;
import com.fengjx.extension.api.tuling.vo.resp.ListBaseBean;
import com.fengjx.extension.api.tuling.vo.resp.ListBean;
import com.fengjx.extension.api.tuling.vo.resp.NewsBean;
import com.fengjx.extension.api.tuling.vo.resp.PriceBean;
import com.fengjx.extension.api.tuling.vo.resp.ResutlCode;
import com.fengjx.extension.api.tuling.vo.resp.SoftBean;
import com.fengjx.extension.api.tuling.vo.resp.TextBean;
import com.fengjx.extension.api.tuling.vo.resp.TrainBean;
import com.fengjx.extension.api.tuling.vo.resp.VideoBean;
import com.fengjx.wechat.sdk.fastweixin.message.Article;
import com.fengjx.wechat.sdk.fastweixin.message.NewsMsg;
...
/**
 * { "  code":302000, "  text":"********", "  list":[{ "      article":"",
 * "      source":"", "      detailurl":"", "      icon":"" }] } 消息转换器 Created
 * by fengjx. Date：2014/12/13 0013
 */
    ...
    public static String toWechatMsg(BaseRespBean bean) {
        ...
        if (ResutlCode.TEXT.getCode().equals(bean.getCode())) {
            ...
            if (CollectionUtils.isNotEmpty(list)) {
                ...
                msg.setMaxSize(list.size() > 10 ? 10 : list.size());
            }
            ...
            TextBean text = (TextBean) bean;
            return new TextMsg("暂不支持该功能[" + text.getCode() + "]").toXml();
        }
        if (alist.size() < 1) {
