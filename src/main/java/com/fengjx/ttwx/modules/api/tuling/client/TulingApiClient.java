...
package com.fengjx.ttwx.modules.api.tuling.client;

import com.fengjx.ttwx.common.utils.HttpUtil;
import com.fengjx.ttwx.modules.api.tuling.vo.MsgConvert;
import com.fengjx.ttwx.modules.api.tuling.vo.req.RequestBean;
import com.fengjx.ttwx.modules.api.tuling.vo.resp.BaseRespBean;
...
public class TulingApiClient {
    ...
    private static final String URL = "http://www.tuling123.com/openapi/api?key=790125ff1b12295b6f914e0b2688b429";
