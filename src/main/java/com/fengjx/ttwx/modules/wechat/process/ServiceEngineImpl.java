...
package com.fengjx.ttwx.modules.wechat.process;
...
import com.fengjx.ttwx.modules.wechat.process.executor.ServiceExecutorFactory;
...
public class ServiceEngineImpl implements ServiceEngine {
    ...
    public String processRequest() {
        ...
        try {
            ...
            if (PublicAccount.VALID_STATE_ACTIVATE.equals(accountRecord.getStr("valid_state"))
    ...
    public String processResult(WxMpXmlOutMessage outMessage, WxMpXmlMessage inMessage) {
        if (null == outMessage) {
