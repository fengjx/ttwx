...
import com.fengjx.wechat.sdk.fastweixin.api.enums.MediaType;
import com.fengjx.wechat.sdk.fastweixin.api.response.BaseResponse;
import com.fengjx.wechat.sdk.fastweixin.api.response.DownloadMediaResponse;
import com.fengjx.wechat.sdk.fastweixin.api.response.UploadMediaResponse;
...
public class MediaAPI extends BaseAPI {
    ...
    public UploadMediaResponse uploadMedia(MediaType type, File file) {
        ...
        String url = "http://file.api.weixin.qq.com/cgi-bin/media/upload?access_token=#&type="
                + type.toString();
    ...
    public DownloadMediaResponse downloadMedia(String mediaId) {
        ...
        String url = "http://file.api.weixin.qq.com/cgi-bin/media/get?access_token="
                + this.config.getAccessToken() + "&media_id=" + mediaId;
        RequestConfig config = RequestConfig.custom()
                .setConnectionRequestTimeout(HttpUtil.CONNECT_TIMEOUT)
                .setConnectTimeout(HttpUtil.CONNECT_TIMEOUT)
                .setSocketTimeout(HttpUtil.CONNECT_TIMEOUT).build();
        ...
        try {
            ...
            if (HttpStatus.SC_OK == r.getStatusLine().getStatusCode()) {
                ...
                if (null != headers && 0 != headers.length) {
                    ...
                    response.setFileName(headers[0].getElements()[0].getParameterByName("filename")
                            .getName());
                } else {
