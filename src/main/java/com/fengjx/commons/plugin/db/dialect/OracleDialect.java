...
public class OracleDialect extends Dialect {
	...
	public void forModelUpdate(Table table, Map<String, Object> attrs, StringBuilder sql, List<Object> paras) {
		sql.append("update ").append(table.getName()).append(" set ");
		String[] pKeys = table.getPrimaryKey();
		for (Entry<String, Object> e : attrs.entrySet()) {
			String colName = e.getKey();
	...
	@Override
	public void forModelFind(Table table, StringBuilder sql, String columns, String orderby, Map<String, Object> attrs, List<Object> paras) {
