 ...
 *
 */
@Component("localFsStorage")
public class LocalFsStorage implements IImagesStorage  {
	...
	public   String getImages() {
		...
		for (File file : files) {
			// imgStr +=
			// file.getPath().replace(getRealPath(request,path),"")+"ue_separate_ue";
			imgStr += file.getPath().replace("\\", "/")
					.replace(AppConfig.STATIC_PATH, "")
					+ "ue_separate_ue";
