...
public class BaseBeanGenerator {
	...
	public BaseBeanGenerator(String baseModelPackageName, String baseModelOutputDir) {
	...
	public void generate(List<TableMeta> tableMetas) {
		System.out.println("Generate base bean ...");
	...
	protected void genSetMethodName(ColumnMeta columnMeta, StringBuilder ret) {
		String setterMethodName = "set" + StrUtil.firstCharToUpperCase(columnMeta.attrName);
	...
	protected void genGetMethodName(ColumnMeta columnMeta, StringBuilder ret) {
		String getterMethodName = "get" + StrUtil.firstCharToUpperCase(columnMeta.attrName);
