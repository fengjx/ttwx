...
public class Generator {
	...
	public Generator(DataSource dataSource, String baseModelPackageName, String baseModelOutputDir, String modelPackageName, String modelOutputDir) {
		this(dataSource, new BaseBeanGenerator(baseModelPackageName, baseModelOutputDir), new ModelServiceGenerator(modelPackageName, baseModelPackageName, modelOutputDir));
	}
	 ...
	 */
	public Generator(DataSource dataSource, BaseBeanGenerator baseModelGenerator, ModelServiceGenerator modelGenerator) {
		if (dataSource == null) {
			throw new IllegalArgumentException("dataSource can not be null.");
		}
		if (baseModelGenerator == null) {
