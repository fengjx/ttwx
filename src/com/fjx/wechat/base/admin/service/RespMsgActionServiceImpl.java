...
public class RespMsgActionServiceImpl extends BaseAbstractService<RespMsgActionEntity> implements RespMsgActionService {
	...
	public Pagination<Map<String,String>> pageMsgAction(Map<String, String> param, SysUserEntity sysUser) {
		...
		StringBuffer sql = new StringBuffer("select a.id as \"id\", a.req_type as \"req_type\", a.action_type as \"action_type\", a.key_word as \"key_word\", a.material_id as \"material_id\", a.app_id as \"app_id\", a.in_time as \"str_in_time\",");
...
//				hql.append(" from RespMsgActionEntity as a ");
//				hql.append(" left join DataDictEntity as d with a.action_type = d.dict_value ");
...
//				hql.append(" and a.sysUser.id = ? ");
		...
		return pageListMapBySql(sql.toString(), parameters);
	}
