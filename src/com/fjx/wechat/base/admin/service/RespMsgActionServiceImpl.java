 ...
 */
@Service
public class RespMsgActionServiceImpl extends BaseAbstractService<RespMsgActionEntity> implements
        RespMsgActionService {

    private Logger logger = Logger.getLogger(this.getClass());

    /*
     * 保存消息动作规则 (non-Javadoc)
     * @see
     * com.fjx.wechat.base.admin.service.RespMsgActionService#saveAction(com
     * .fjx.wechat.base.admin.entity.RespMsgActionEntity,
     * com.fjx.wechat.base.admin.entity.WechatMenuEntity,
     * com.fjx.wechat.base.admin.entity.MaterialEntity)
     */
    @Override
    public void saveAction(RespMsgActionEntity actionEntity, WechatMenuEntity menuEntity,
    ...
    /*
     * 更新消息动作规则 (non-Javadoc)
     * @see
     * com.fjx.wechat.base.admin.service.RespMsgActionService#updateAction(com
     * .fjx.wechat.base.admin.entity.RespMsgActionEntity,
     * com.fjx.wechat.base.admin.entity.WechatMenuEntity,
     * com.fjx.wechat.base.admin.entity.MaterialEntity)
     */
    @Override
    public void updateAction(RespMsgActionEntity actionEntity, WechatMenuEntity menuEntity,
            MaterialEntity materialEntity) {
     ...
     * (non-Javadoc)
     * @see
     * com.fjx.wechat.base.admin.service.RespMsgActionService#loadMsgAction(
     * java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public RespMsgActionEntity loadMsgAction(String ext_type, String req_type, String event_type,
            String key_word, SysUserEntity sysUser) {
     ...
     * (non-Javadoc)
     * @see
     * com.fjx.wechat.base.admin.service.RespMsgActionService#deleteMsgActionById
     * (java.lang.String)
     */
    @Override
     ...
     * @see
     * com.fjx.wechat.base.admin.service.RespMsgActionService#deleteMsgActionByKey
     * (java.lang.String)
     */
    @Override
    ...
    @Override
    public Pagination<KeyWordActionView> pageMsgAction(Map<String, String> param,
            SysUserEntity sysUser) {
        List<Object> parameters = new ArrayList<Object>();
        // StringBuffer sql = new
        // StringBuffer("select a.id as id, a.req_type as req_type, a.action_type as action_type, a.key_word as key_word, a.material_id as material_id, a.app_id as app_id, a.in_time as in_time,");
        ...
        StringBuffer hql = new StringBuffer(
                "select new com.fjx.wechat.base.admin.entity.KeyWordActionView( ");
        ...
        // StringBuffer sql = new
        // StringBuffer("select a.id id, a.req_type req_type, a.action_type action_type, a.key_word key_word, a.material_id material_id, a.app_id app_id, a.in_time in_time, a.user_id user_id, a.beanName beanName, a.methodName methodName, a.app_name app_name, a.xml_data xml_data, a.msg_type msg_type, a.dict_name dict_name ");
     ...
     */
    private void saveMenuAction(RespMsgActionEntity actionEntity, WechatMenuEntity menuEntity,
            MaterialEntity materialEntity) {
        Date now = new Date();
    ...
    private void saveMsgAction(RespMsgActionEntity actionEntity, MaterialEntity materialEntity) {
        ...
        RespMsgActionEntity actionEntity2 = loadMsgAction(actionEntity.getExt_type(),
                actionEntity.getReq_type(), actionEntity.getEvent_type(),
                actionEntity.getKey_word(), actionEntity.getSysUser());
