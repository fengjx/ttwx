...
public class WechatApiAction extends BaseController {
	...
	@ResponseBody
	public String valid(String signature,String timestamp,String nonce,String echostr, String ticket) {
		logger.info("微信接口认证请求[signature="+signature+" timestamp="+timestamp+" nonce="+nonce+" echostr="+echostr+" ticket="+ticket+"]");
        ...
        return "error for valid--> signature="+signature+" timestamp="+timestamp+" nonce="+nonce+" echostr="+echostr+" myToken="+token;
	}
